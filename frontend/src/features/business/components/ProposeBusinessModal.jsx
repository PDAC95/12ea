...
import { proposeBusinessSchema } from '../validation/proposeBusinessSchema';
import { BUSINESS_CATEGORIES } from '../../../shared/constants/categories';

/**
 * ProposeBusinessModal - Modal para proponer un negocio
 *
 * Features:
 ...
 */
const ProposeBusinessModal = ({ isOpen, onClose, onSuccess }) => {
  ...
  const {
    ...
    resolver: yupResolver(proposeBusinessSchema),
  ...
  const onSubmit = async (data) => {
    ...
    console.log('🔍 onSubmit - data recibida de React Hook Form:', data);
    ...
    try {
      ...
      // POST /businesses/propose (CORREGIDO: era /business/propose - singular)
      const response = await api.post('/businesses/propose', formData, {
        headers: {
      ...
      // Success
      showToast('success', '¡Gracias! Tu negocio será revisado por nuestro equipo');
      handleClose();
      ...
      <div className="flex min-h-screen items-center justify-center p-4">
        ...
        <div className="relative w-full max-w-2xl bg-white rounded-2xl shadow-soft-lg">
          ...
          <div className="flex items-center justify-between p-6 border-b border-gray-200">
            <h2 className="text-2xl font-display font-bold text-gray-900">Agregar Mi Negocio</h2>
            <button
              onClick={handleClose}
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
              <p className="text-sm text-blue-800">
                Tu negocio será revisado por nuestro equipo antes de aparecer en el directorio.
...
ProposeBusinessModal.propTypes = {
  isOpen: PropTypes.bool.isRequired,
  onClose: PropTypes.func.isRequired,
  onSuccess: PropTypes.func,
};

export default ProposeBusinessModal;
